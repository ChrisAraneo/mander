...
export const PLAYER_FIREBALL_ORBIT_TILES = 4.8;

export const PLAYER_FIREBALL_ORBIT_RADIUS =
  PLAYER_FIREBALL_ORBIT_TILES * TILE_SIZE;

export const PLAYER_FIREBALL_ORBIT_SECONDS = 2.2 / 1.5;

export const PLAYER_FIREBALL_ANGULAR_SPEED =
  (Math.PI * 2) / PLAYER_FIREBALL_ORBIT_SECONDS;

export const PLAYER_FIREBALL_SWEEP_STEP = FIREBALL_SIZE / 2;
